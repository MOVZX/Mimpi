...
const checkpointNameMapping = {
  ...
  "Illustrious/perfection3DILXLIllustrious_v11.safetensors": {
    displayName:
      "Perfection 3D [ILXL / Illustrious XL] - NSFW / SFW Checkpoint | v1.1",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
  ...
  "Illustrious/perfectionAmateurILXL_v10.safetensors": {
    displayName:
      "Perfection Amateur [ILXL / Illustrious XL] - NSFW / SFW Checkpoint | 1.0",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
  ...
  "Illustrious/reallybiglust_v095LoraCompatible.safetensors": {
    displayName:
      "ReallyBigLust - Illustrious Realistic | v0.98 LoRA Compatible",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
  ...
  "Pony/fucktasticRealCheckpointPony_21.safetensors": {
    displayName:
      "Fucktastic Real Checkpoint [Pony/PDXL Porn] [Realistic] [NSFW/SFW] | 2.1",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
  ...
  "SDXL/cinemaDiffusoXL_beta03.safetensors": {
    displayName: "Cinema Diffuso XL | Beta 0.3",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
  ...
  "SDXL/cyberrealisticXL_v56.safetensors": {
    displayName: "CyberRealistic XL | v5.6",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
  ...
  "SDXL/evalisenniaRealisticEastAsian_v30.safetensors": {
    displayName:
      "Evalisennia 伊岚: Realistic East Asian Female | 写实东亚女性人像 | v3.0",
    sampler: "lcm",
    scheduler: "exponential",
    lora: false,
    clip: true,
